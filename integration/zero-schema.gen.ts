...
export type OrderTableCurrencyMetadataCustomType = ZeroCustomType<
  typeof zeroSchema,
  'orderTable',
  'currencyMetadata'
>;
export type ProductMediaMimeDescriptorCustomType = ZeroCustomType<
  typeof zeroSchema,
  'productMedia',
  'mimeDescriptor'
>;
export type ProductMediaTypeCustomType = ZeroCustomType<
  typeof zeroSchema,
  'productMedia',
  'type'
>;
export type ProjectWorkflowStateCustomType = ZeroCustomType<
  typeof zeroSchema,
  'project',
  'workflowState'
>;
export type ProjectAuditDetailsCustomType = ZeroCustomType<
  typeof zeroSchema,
  'projectAudit',
  'details'
>;
export type UserCustomInterfaceJsonCustomType = ZeroCustomType<
  typeof zeroSchema,
  'user',
  'customInterfaceJson'
>;
export type UserCustomTypeJsonCustomType = ZeroCustomType<
  typeof zeroSchema,
  'user',
  'customTypeJson'
>;
export type UserNotificationPreferencesCustomType = ZeroCustomType<
  typeof zeroSchema,
  'user',
  'notificationPreferences'
>;
export type UserTestExportedTypeCustomType = ZeroCustomType<
  typeof zeroSchema,
  'user',
  'testExportedType'
>;
export type UserTestInterfaceCustomType = ZeroCustomType<
  typeof zeroSchema,
  'user',
  'testInterface'
>;
export type UserTestTypeCustomType = ZeroCustomType<
  typeof zeroSchema,
  'user',
  'testType'
>;
